...
modules_enabled = {
	...
	-- Nice to have
		...
		"register_ibr"; -- Allow users to register on this server using a client and change passwords
...
registration_instructions = "sug en kuk"
...
--sql = { driver = "PostgreSQL", database = "postgres", username = "postgres", password = "password", host = "localhost" }
...
Component "proxy.a-nord.se" "proxy65"
